    ...
    <div class="container">
        <section>
            ...
            <ul class="thumbnails players">
                ...
                <li class="thumbnail player">
                    <img src="img/heads/futurepaul.png" alt="futurepaul" />
                    <div class="caption text-center">futurepaul</div>
                </li>
            </ul>
            ...
            <ul class="thumbnails players">
                <li class="thumbnail player">
                    <img src="img/heads/blind_guy23.png" alt="blind_guy23" />
                ...
                <li class="thumbnail player">
                    <img src="img/heads/gjennings.png" alt="gjennings" />
                    <div class="caption text-center">gjennings</div>
                </li>
                <li class="thumbnail player">
                    <img src="img/heads/lukemags.png" alt="lukemags" />
                    <div class="caption text-center">lukemags</div>
                </li>
                <li class="thumbnail player">
                    <img src="img/heads/meganelizzzabeth.png" alt="meganelizzzabeth" />
                ...
                <li class="thumbnail player">
                    <img src="img/heads/ndwatkins.png" alt="ndwatkins" />
